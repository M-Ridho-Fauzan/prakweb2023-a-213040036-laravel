...
CREATE DATABASE IF NOT EXISTS `wpu_blog` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `wpu_blog`;
...
-- Dumping structure for table wpu_blog.password_reset_tokens
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `author` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Fulan',
